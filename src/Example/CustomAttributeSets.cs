...
public class CharacterAttributeSet : AttributeSet
{
    ...
    [
        _hp, _defense, _attack, _gravity, _runspeed, _walkspeed, _jumpvelocity, _flooracceleration, _airacceleration,
        _slidingdeceleration
    ];

    public override Tag[] AttributeTags =>
    [
        Tags.Attribute_HP, Tags.Attribute_Defense, Tags.Attribute_Attack, Tags.Attribute_Gravity,
        Tags.Attribute_RunSpeed, Tags.Attribute_WalkSpeed, Tags.Attribute_JumpVelocity,
        Tags.Attribute_FloorAcceleration, Tags.Attribute_AirAcceleration, Tags.Attribute_SlidingDeceleration
    ];
