...
public class EffectPeriodTicker
{
    ...
    private int StackCount => _effect.Stacking.StackCount;
    ...
    {
        var oldStackCount = _effect.Stacking.StackCount;
        RefreshStack(_effect.Stacking.StackCount + 1);
        _effect.RaiseOnStackCountChanged(oldStackCount, _effect.Stacking.StackCount);
        return oldStackCount != _effect.Stacking.StackCount;
    }
