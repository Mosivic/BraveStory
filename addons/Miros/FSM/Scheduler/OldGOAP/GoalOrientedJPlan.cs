...
using Godot;
using FSM.Job;
using FSM.Job.Config;

namespace FSM.AI;

public class GoalOrientedJPlan : AbsScheduler
{
    private readonly List<State> _goalQueue;
    private readonly List<Goal> _goals;
    private readonly Planner _planner;

    public GoalOrientedJPlan(List<State> states, List<Goal> goals) : base(states)
    {
        _goals = goals;
        _planner = new Planner(JobWrapper);
        _goalQueue = new List<State>();
    }
